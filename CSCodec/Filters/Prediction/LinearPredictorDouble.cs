...
namespace CSCodec.Filters.Prediction
{
    ...
    {
        /// <summary>
        /// The machine epsilon for <see cref="double"/>
        /// </summary>
        private static readonly double CEpsilon = BitConverter.Int64BitsToDouble(0x3CB0000000000000);
        ...
        public override void Initialize(ReadOnlySpan<double> data, int Order, out Span<double> errors)
        {
        ...
        public override void Predict(ReadOnlySpan<double> first, Span<double> output)
        {
        ...
        /// <param name="errors">The errors.</param>
        private static void LevinsonDurbinRecursion(Span<double> coeff, ReadOnlySpan<double> acorr, int order, out Span<double> errors)
        {
            int delay, index;
            double lambda;
        ...
        public override void Reset(ReadOnlySpan<double> coefficents)
        {
